...
@OnlyIn(Dist.CLIENT)
public class YggdrasilChestBoatRenderer extends EntityRenderer<YggdrasilChestBoat> {
    private final Map<YggdrasilBoat.Type, Pair<ResourceLocation, YggdrasilChestBoatModel>> boatResources;

    public YggdrasilChestBoatRenderer(EntityRendererProvider.Context p_234563_) {
        super(p_234563_);
    ...
    public void render(YggdrasilChestBoat p_113929_, float p_113930_, float p_113931_, PoseStack p_113932_, MultiBufferSource p_113933_, int p_113934_) {
        ...
        Pair<ResourceLocation, YggdrasilChestBoatModel> pair = getModelWithLocation(p_113929_);
        ResourceLocation resourcelocation = pair.getFirst();
        YggdrasilChestBoatModel boatmodel = pair.getSecond();
    ...
    public ResourceLocation getTextureLocation(YggdrasilChestBoat p_113927_) {
        return getModelWithLocation(p_113927_).getFirst();
    }

    public Pair<ResourceLocation, YggdrasilChestBoatModel> getModelWithLocation(YggdrasilChestBoat boat) { return this.boatResources.get(boat.getBoatType()); }
}
