...
@OnlyIn(Dist.CLIENT)
public class YggdrasilBoatRenderer extends EntityRenderer<YggdrasilBoat> {
    private final Map<YggdrasilBoat.Type, Pair<ResourceLocation, YggdrasilBoatModel>> boatResources;

    public YggdrasilBoatRenderer(EntityRendererProvider.Context p_234563_) {
        super(p_234563_);
    ...
    private static String getTextureLocation() {
        return "textures/entity/boat/oak.png";
    }

    public void render(YggdrasilBoat p_113929_, float p_113930_, float p_113931_, PoseStack p_113932_, MultiBufferSource p_113933_, int p_113934_) {
        p_113932_.pushPose();
        ...
        Pair<ResourceLocation, YggdrasilBoatModel> pair = getModelWithLocation(p_113929_);
        ResourceLocation resourcelocation = pair.getFirst();
        YggdrasilBoatModel boatmodel = pair.getSecond();
    ...
    public ResourceLocation getTextureLocation(YggdrasilBoat p_113927_) {
        return getModelWithLocation(p_113927_).getFirst();
    }

    public Pair<ResourceLocation, YggdrasilBoatModel> getModelWithLocation(YggdrasilBoat boat) { return this.boatResources.get(boat.getBoatType()); }
}
