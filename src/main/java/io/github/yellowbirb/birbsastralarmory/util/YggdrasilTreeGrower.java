...
public class YggdrasilTreeGrower extends AbstractMegaTreeGrower {
   ...
   private static TreeConfiguration.TreeConfigurationBuilder createYggdrasilBranch() {
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> YGGDRASIL_JUNGLE_TREE = FeatureUtils.register("yggdrasil_jungle_tree", Feature.TREE, createJungleTree().decorators(ImmutableList.of(new CocoaDecorator(0.2F), TrunkVineDecorator.INSTANCE, new LeaveVineDecorator(0.25F))).ignoreVines().build());
    ...
    public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> YGGDRASIL_SWAMP_OAK = FeatureUtils.register("yggdrasil_swamp_oak", Feature.TREE, createStraightBlobTree(BlockInit.yggdrasil_log.get(), BlockInit.yggdrasil_leaves.get(), 5, 3, 0, 3).decorators(ImmutableList.of(new LeaveVineDecorator(0.25F))).build());
