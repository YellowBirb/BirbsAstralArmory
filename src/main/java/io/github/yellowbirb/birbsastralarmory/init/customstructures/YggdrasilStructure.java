package io.github.yellowbirb.birbsastralarmory.init.customstructures;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import io.github.yellowbirb.birbsastralarmory.init.StructureInit;
...
public class YggdrasilStructure extends Structure {

    // A custom codec that changes the size limit for our code_structure_sky_fan.json's config to not be capped at 7.
    // With this, we can have a structure with a size limit up to 30 if we want to have extremely long branches of pieces in the structure.
    public static final Codec<YggdrasilStructure> CODEC = RecordCodecBuilder.<YggdrasilStructure>mapCodec(instance ->
            instance.group(YggdrasilStructure.settingsCodec(instance),
            ...
            ).apply(instance, YggdrasilStructure::new)).codec();
    ...
    public YggdrasilStructure(Structure.StructureSettings config,
    ...
    public Optional<Structure.GenerationStub> findGenerationPoint(Structure.GenerationContext context) {
        ...
        if (!YggdrasilStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> type() {
        return StructureInit.YGGDRASIL_STRUCTURE.get(); // Helps the game know how to turn this structure back to json to save to chunks
    }
}