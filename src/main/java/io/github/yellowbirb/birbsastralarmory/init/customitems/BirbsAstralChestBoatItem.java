...
public class BirbsAstralChestBoatItem extends Item {
    ...
    private BirbsAstralChestBoat getBoat(Level p_220017_, HitResult p_220018_) {
        return (BirbsAstralChestBoat)(new BirbsAstralChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}