package io.github.yellowbirb.birbsastralarmory.init.customitems;
...
public class YggdrasilChestBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final YggdrasilChestBoat.Type type;
    private final boolean hasChest;

    public YggdrasilChestBoatItem(boolean p_220013_, YggdrasilChestBoat.Type p_220014_, Item.Properties p_220015_) {
        super(p_220015_);
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                YggdrasilChestBoat boat = this.getBoat(p_40622_, hitresult);
    ...
    private YggdrasilChestBoat getBoat(Level p_220017_, HitResult p_220018_) {
        return (YggdrasilChestBoat)(new YggdrasilChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}