package io.github.yellowbirb.birbsastralarmory.templates;

import com.mojang.blaze3d.shaders.FogShape;
import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.math.Vector3f;
import io.github.yellowbirb.birbsastralarmory.init.BlockInit;
import io.github.yellowbirb.birbsastralarmory.init.FluidInit;
...
public class BaseBirbFluidType {
    ...
    public BaseBirbFluidType(String name, FluidType.Properties typeProperties,
                             Supplier<IClientFluidTypeExtensions> clientExtensions, @Nullable AdditionalProperties additionalProperties,
                             RegistryObject<LiquidBlock> liquidBlockRegistryObject, RegistryObject<BucketItem> bucketItemRegistryObject) {
        ...
        this.block = liquidBlockRegistryObject;
        this.properties.block(this.block);

        this.bucket = bucketItemRegistryObject;
        this.properties.bucket(this.bucket);
    }

    public BaseBirbFluidType(String name, FluidType.Properties typeProperties,
                                  Supplier<IClientFluidTypeExtensions> clientExtensions,
                                  RegistryObject<LiquidBlock> liquidBlockRegistryObject,
                                  RegistryObject<BucketItem> bucketItemRegistryObject) {
        this(name, typeProperties, clientExtensions, null, liquidBlockRegistryObject, bucketItemRegistryObject);
    }
